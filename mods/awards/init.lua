...
dofile(core.get_modpath("awards").."/api.lua")
...
awards.register_achievement("award_lumberjack",{
	...
	icon = core.inventorycube("default_tree_top.png", "default_tree.png", "default_tree.png"),
	trigger = {
		type = "dig",
		node = "default:tree",
		target = 100
...
awards.register_achievement("award_junglebaby",{
	...
	icon = core.inventorycube("default_jungletree_top.png", "default_jungletree.png", "default_jungletree.png"),
	trigger = {
		type = "dig",
...
awards.register_achievement("award_youre_a_copper",{
	...
	icon = core.inventorycube("default_copper_block.png", "default_copper_block.png", "default_copper_block.png"),
	background = "awards_bg_mining.png",
	trigger = {
		type = "dig",
...
awards.register_achievement("award_youre_winner",{
	...
	icon = core.inventorycube("default_mossycobble.png", "default_mossycobble.png", "default_mossycobble.png"),
	background = "awards_bg_mining.png",
	trigger = {
		type = "dig",
...
awards.register_onDeath(function(player,data)
	...
	if pos and core.find_node_near(pos, 2, "fire:basic_flame") ~= nil then
		return "award_burn"
	end
	return nil
end)
...
awards.register_onDeath(function(player,data)
	local pos = player:getpos()
	if pos and core.find_node_near(pos, 2, "default:lava_flowing") ~= nil then
...
awards.register_onDeath(function(player,data)
	local pos = player:getpos()
	if pos and core.find_node_near(pos, 5, "default:stone_with_diamond") ~= nil then
...
awards.register_onDeath(function(player,data)
	local pos = player:getpos()
	if pos and core.find_node_near(pos, 5, "bones:bones") ~= nil then
