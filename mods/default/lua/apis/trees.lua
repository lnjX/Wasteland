function default.register_planks(name, def)
	def.register = def.register or {stair = true, slab = true, table = true,
					chair = true, fence = true, fencegate = true}
	def.groups = def.groups or {choppy = 2, oddly_breakable_by_hand = 2,
					flammable = 3, wood = 1, fuel = 8}
	...
	def.chair = def.chair or {description = def.description_prefix .. " Chair"}
