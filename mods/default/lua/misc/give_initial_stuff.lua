-- mods/default/lua/misc/give_initial_stuff.lua
-- ============================================
-- See README.txt for licensing and other information.

local stuff_string = core.setting_get("initial_stuff") or
		"default:craft_guide"
-- example for multiple items: "default:xyz,default:torch 100,farming:potato"
...
if core.setting_getbool("give_initial_stuff") or true then
